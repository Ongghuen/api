            ...
            <div class="table-responsive p-0">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold">Rp.120.000</span>
                        </td>
                        <td class="align-middle text-center">
                        ...
                        <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold">14-08-2022</span>
                        </td>
                    </tr>
                    ...
                    <div class="modal-delete" id="modal-delete">
                        ...
                        <div class="modal-body-delete">
                            ...
                            <div class="align-middle text-center">
                                <a class="btn btn-danger btn-sm ms-auto" href="hapus_product.php">Delete</a>
