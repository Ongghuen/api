        ...
        <div class="card mb-4">
            ...
            <div class="table-responsive p-0">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="align-middle text-center">
                        <button class="btn btn-secondary btn-sm px-3 py-1 me-1 mt-3" data-modal-target="#modal-detail">Cek Detail</button>
                        </td>
                        <td class="align-middle text-center">
                    ...
                    <div class="modal-detail" id="modal-detail">
                        ...
                        <div class="modal-body-detail">
                            <form class="anjasmara" action="edit_custom.php" method="post">
                    ...
                    <div class="modal-delete" id="modal-delete">
                        ...
                        <div class="modal-body-delete">
                            ...
                            <div class="align-middle text-center">
                                <a class="btn btn-danger btn-sm ms-auto" href="hapus_custom.php">Delete</a>
            ...
            <div class="modal-edit" id="modal-edit">
                ...
                <div class="modal-body-edit">
                    <form action="edit_custom.php" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">Detail</label>
                        <textarea class="form-control" name="detail" id="exampleFormControlTextarea1" maxlength="500" rows="5"></textarea>
                    </div>
